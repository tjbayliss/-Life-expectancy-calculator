			...
			dvc.finalYear = 2180;// final data year in life/QX tables provided by Julie Mills			
			...
			var margin = { top : 35, bottom : 65, left : 30, right : 25 }; // initialise all four margins
			var graphic_aspect_width = 16; // initialise graphic_aspect_width
			var graphic_aspect_height = 7; // initialise graphic_aspect_width
			...
			$('.btn-default')
				.on('click', function(){
					...
					if ( dvc.selectedGender != "" && regExp.test($("#currentAge").val()) == true ) { d3.select("#compareBtn").attr("class","btn btn-primary"); }
			...
			if (Modernizr.inlinesvg/* == false*/ )
			{
				...
				$(document).ready(function()
				{
						...
						dvc.lastYear = 2180; // last year represented in QX tables
						dvc.currentYear = 2015; // this very current years. Needs to be updated accordingly to maintain currency of interative
						...
						{	
							...
							var yourSPAArray = { 
											"features": [															
															...
															{ "properties": { "birthYear" : "1953" , "male" : "65" , "female" : "63" } } , 
															{ "properties": { "birthYear" : "1954" , "male" : "66" , "female" : "65" } } , 
				...
				*/
				function makeChart()
				{
					...
					var num_ticks = 10;
					if (width < mobile_threshold ) { num_ticks = 10; }
